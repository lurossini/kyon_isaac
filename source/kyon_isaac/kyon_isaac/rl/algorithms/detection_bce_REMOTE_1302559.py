...
class DetectionBCE:
    ...
    def __init__(
        ...
        for idx, m in enumerate(self.policy.modules()):
            print(idx, '->', m)
        exit()
        ...
        if loss_type in loss_fn_dict:
            ...
            self.confidence_loss_fn = loss_fn_dict["bce"]
        else:
    ...
    def act(self, obs: TensorDict) -> torch.Tensor:
        ...
        self.transition.latent = self.policy.get_latent(obs).detach()
    ...
    def update(self) -> dict[str, float]:
        ...
        for (
            ...
            mean_confidence_loss += confidence_loss.item()

        # Divide the losses by the number of updates
        num_updates = self.num_learning_epochs * self.num_mini_batches
        mean_latent_loss /= num_updates
        mean_confidence_loss /= num_updates
