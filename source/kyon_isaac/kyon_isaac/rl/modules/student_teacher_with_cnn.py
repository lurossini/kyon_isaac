...
from kyon_isaac.rl.networks.cnn import CNN


class StudentTeacherWithCNN(nn.Module):
    ...
    def __init__(
        ...
        **kwargs: dict[str, Any],
        ...
        if student_obs_normalization:
            self.student_obs_normalizer = EmpiricalNormalization(num_student_obs + latent_dim)
        else:
    ...
    def act(self, obs: TensorDict) -> torch.Tensor:
        ...
        self.latent = self.student_cnn(obs_rgb)
