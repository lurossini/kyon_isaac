...
KYON_FULL_BODY_CFG_TRAIN = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
...
KYON_WHEEL_BODY_CFG_TRAIN = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
...
KYON_SIMPLE_WHEEL_BODY_CFG_TRAIN = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{os.path.abspath(os.path.dirname(__file__))}/kyon_full_simple_wheels.usd",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            rigid_body_enabled=True,
            max_linear_velocity=1000.0,
